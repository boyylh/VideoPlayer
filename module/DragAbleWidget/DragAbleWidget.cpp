...
//                    rMove.setX(gloPoint.x());
                //rMove.setWidth( rb.x() - gloPoint.x() );
            ...
            QPoint newtl = mapToParent( mapFromGlobal(rMove.topLeft()));
            QPoint newrb = mapToParent( mapFromGlobal(rMove.bottomRight()));
            this->setGeometry(QRect(newtl, newrb));
...
//        mTimer_CheckTitle->stop();
    ...
    this->showMinimized();
    this->resize(160,ui->widget_title->size().height());
